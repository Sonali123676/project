        ...
        <div >
            ...
            <div className="login_container">
                ...
                <div className="col-md-6 m-auto" style={{ opacity: 1 }}>
                    ...
                    <p style={{ color: "white", fontWeight: "800", textAlign: "center" }}>A Student's Library
                    </p>
                ...
                <br />
                <Link to="/" style={{ fontFamily: "sans-serif", color: "white", textDecoration: "none" }}>Click here to go back to Home Page</Link>
