    ...
    return (
        <div style={{marginTop:"10%"}}>
            <ul>
               ...
               <Link  to="/dashboard/addBook"   style={{textDecoration:"none",color:"#f1f1f1",fontSize:"20px",marginLeft:"5px",fontFamily:"Oswald"}}> Add Books </Link>  </li>
               <hr style={{color:"white"}} />
                       ...
                       <li> <i className="fas fa-book text-white"></i> <Link  to="/dashboard/allissuedBook" 
                         style={{textDecoration:"none",color:"#f1f1f1",fontSize:"20px",marginLeft:"5px",fontFamily:"Oswald"}}> All Issued Books </Link>  </li>
                       <hr style={{color:"white"}} />
                       <li> <i className="fas fa-book text-white"></i> <Link  to="/dashboard/issue_return" 
                         style={{textDecoration:"none",color:"#f1f1f1",fontSize:"20px",marginLeft:"5px",fontFamily:"Oswald"}}> Books Issued today </Link>  </li>
                       <hr style={{color:"white"}} />
                       <li> <i className="fas fa-book text-white"></i> <Link  to="/dashboard/returnBook" 
                         style={{textDecoration:"none",color:"#f1f1f1",fontSize:"20px",marginLeft:"5px",fontFamily:"Oswald"}}> Books Returned today </Link>  </li>
                       <hr style={{color:"white"}} />
                    ...
                    <li> <i className="fas fa-book text-white"></i> <Link  to="/dashboard/issuedBook" 
                      style={{textDecoration:"none",color:"#f1f1f1",fontSize:"20px",marginLeft:"5px",fontFamily:"Oswald"}}> CurrentlyIssued Book</Link>  </li>
                    <hr style={{color:"white"}} />
                    </>
                  )}
