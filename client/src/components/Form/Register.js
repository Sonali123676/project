            ...
            return (
              ...
              <div className="container">
                <div style={{ marginLeft: "37%" }}>
                  <div id="circle"></div>
                 <h1 style={{ color: "black", marginLeft: "44px", marginTop: "-70px", fontSize: "45px"}}>Book-Hive</h1>
                </div>
                <p style={{ color: "black", fontWeight: "800", textAlign: "center" }}>A Student's Library
                  </p>
                ...
                <div style={{ marginTop: "10px", marginLeft: "28%" }}>
                  <Link to="/login"
                    style={{
                     ...
                     Already an account then please Login</Link>
                </div>
